...
Ce document décrit **111 exercices** répartis en 4 lots et 27 thématiques. Chaque exercice est décrit selon une trame identique en 10 rubriques, afin que la production puisse être répartie entre plusieurs contributeurs sans perte d'homogénéité.
...
Un exercice par famille de composants natifs de Grasshopper pour Rhino 8. Objectif : savoir ce que fait le composant, quelles entrées il attend et quelle donnée il produit. Aucun plugin tiers n'est autorisé dans ce lot.
...
| A-15 | Répartir avec Dispatch | A3 · Listes | Débutant | 7 min | SetEquality |
...
| A-19 | Lire un chemin d'arbre | A4 · Arbres de données | Débutant | 7 min | ExactOrderedList |
...
| A-27 | Construire une chaîne de caractères | A6 · Outils de texte | Débutant | 6 min | ExactOrderedList |
| A-28 | Découper et remplacer du texte | A6 · Outils de texte | Débutant | 7 min | ExactOrderedList |
| A-29 | Comparer deux valeurs | A7 · Portes logiques | Débutant | 5 min | SingleValue |
| A-30 | Combiner plusieurs conditions | A7 · Portes logiques | Débutant | 7 min | SetEquality |
...
| A-43 | Fermer une polysurface en solide | A10 · Surfaces et solides | Débutant | 7 min | SingleValue |
...
**1. Objectif pédagogique** — Comprendre qu'un composant reçoit une donnée à gauche et la restitue à droite, et que le câble transporte cette donnée.

**2. Composants mobilisés** — Number Slider, Panel, Addition

**3. Zone SUJET — texte du Scribble**

> Un Number Slider est posé sur le canvas. Ajoute un second Number Slider, additionne les deux valeurs et affiche le résultat dans un Panel. Règle les curseurs pour que la somme vaille exactement 42.

**4. Données de départ fournies** — Un Number Slider (0-100, valeur 17) déjà placé.

**5. Résultat attendu** — Un Panel affichant la valeur 42.
...
**1. Objectif pédagogique** — Distinguer un paramètre numérique d'une géométrie et construire un point à partir de trois nombres.

**2. Composants mobilisés** — Number Slider, Construct Point, Point

**3. Zone SUJET — texte du Scribble**

> Construis le point de coordonnées X=30, Y=-15, Z=8 à l'aide de trois Number Sliders et d'un composant Construct Point. Le point doit être visible dans la vue Rhino.
...
**1. Objectif pédagogique** — Comprendre la différence entre une donnée calculée en amont et une donnée figée dans un paramètre.

**2. Composants mobilisés** — Point (paramètre), Set One Point, Internalise data
...
**1. Objectif pédagogique** — Faire circuler la géométrie entre Rhino et Grasshopper dans les deux sens.

**2. Composants mobilisés** — Curve (paramètre), Geometry Pipeline, Bake (menu contextuel)

**3. Zone SUJET — texte du Scribble**

> Le fichier Rhino contient trois cercles sur le calque « CERCLES ». Récupère-les dans Grasshopper sans les sélectionner un par un, décale-les de 50 mm en Z, puis cuis le résultat sur le calque « COPIES ».

**4. Données de départ fournies** — Fichier 3DM joint contenant trois cercles sur le calque CERCLES.

**5. Résultat attendu** — Trois cercles cuits sur le calque COPIES, décalés de 50 mm en Z.
...
| **Prérequis** | A-01 |
| **Mode de validation** | SingleValue — tolérance 0 |
| **Solution de référence** | 2 composants |
| **Gamification associée** | G-17 Quiz éclair |
| **Statut de production** | À produire |

**1. Objectif pédagogique** — Savoir inspecter un flux : nombre d'éléments, type et structure.

**2. Composants mobilisés** — Panel, Param Viewer, Number, Quick Graph
...
**1. Objectif pédagogique** — Observer qu'un composant attendant un entier arrondit silencieusement une valeur décimale.

**2. Composants mobilisés** — Number Slider, Series, Panel
...
**1. Objectif pédagogique** — Reconnaître un composant en échec et lire le message d'erreur.

**2. Composants mobilisés** — Panel, Addition, Number
...
**1. Objectif pédagogique** — Comprendre l'équivalence True/1 et False/0 et son usage pour compter.

**2. Composants mobilisés** — Boolean Toggle, Mass Addition, Larger Than

**3. Zone SUJET — texte du Scribble**

> Une liste de 10 nombres est comparée à la valeur 5. Compte combien d'éléments sont strictement supérieurs à 5, sans utiliser de composant de filtrage.

**4. Données de départ fournies** — Une liste de 10 nombres internalisée et un slider réglé sur 5.

**5. Résultat attendu** — Un Panel affichant le nombre d'éléments supérieurs à 5.
...
**1. Objectif pédagogique** — Repérer une valeur nulle dans une liste et mesurer son effet en aval.

**2. Composants mobilisés** — Panel, Null Item, Clean Tree, List Length

**3. Zone SUJET — texte du Scribble**

> Une liste de 8 nombres contient deux valeurs nulles. Nettoie la liste et indique dans un Panel combien d'éléments valides subsistent.

**4. Données de départ fournies** — Une liste de 8 éléments internalisée dont 2 nulles.

**5. Résultat attendu** — Un Panel affichant 6.
...
**1. Objectif pédagogique** — Générer une suite de nombres et distinguer les deux logiques de génération.

**2. Composants mobilisés** — Series, Range, Panel

**3. Zone SUJET — texte du Scribble**

> Produis avec Series la suite 10, 15, 20, 25, 30 puis, avec Range, la même suite. Affiche les deux dans deux Panels distincts.

**4. Données de départ fournies** — Canvas vide.

**5. Résultat attendu** — Deux Panels contenant chacun 10, 15, 20, 25, 30.
...
**1. Objectif pédagogique** — Lire un élément par son index et comprendre l'indexation à partir de zéro.

**2. Composants mobilisés** — List Item, Series, Panel

**3. Zone SUJET — texte du Scribble**

> La liste contient 10 lettres de A à J. Extrais la lettre D, puis la dernière lettre de la liste sans coder son index en dur.

**4. Données de départ fournies** — Une liste de 10 textes internalisée.

**5. Résultat attendu** — Deux Panels : l'un affiche D, l'autre J.
...
**1. Objectif pédagogique** — Mesurer une liste et en extraire les valeurs extrêmes.

**2. Composants mobilisés** — List Length, Bounds, Deconstruct Domain, Sort List

**3. Zone SUJET — texte du Scribble**

> Pour la liste fournie, affiche dans un même Panel le nombre d'éléments, la valeur minimale et la valeur maximale, dans cet ordre.

**4. Données de départ fournies** — Une liste de 15 nombres non triés internalisée.

**5. Résultat attendu** — Un Panel de trois lignes : effectif, minimum, maximum.
...
**1. Objectif pédagogique** — Trier une liste secondaire selon les valeurs d'une liste de clés.

**2. Composants mobilisés** — Sort List, Reverse List, Panel

**3. Zone SUJET — texte du Scribble**

> Six pièces portent un nom et une longueur. Classe les noms de la pièce la plus longue à la plus courte.

**4. Données de départ fournies** — Deux listes internalisées : 6 noms et 6 longueurs.

**5. Résultat attendu** — Un Panel listant les noms par longueur décroissante.
...
**1. Objectif pédagogique** — Éliminer des éléments selon un motif booléen répétitif.

**2. Composants mobilisés** — Cull Pattern, Boolean Toggle, Panel

**3. Zone SUJET — texte du Scribble**

> La liste contient 12 nombres. Conserve un élément sur trois en commençant par le premier.

**4. Données de départ fournies** — Une liste de 12 nombres internalisée.

**5. Résultat attendu** — Une liste de 4 éléments : index 0, 3, 6 et 9.
...
**1. Objectif pédagogique** — Séparer une liste en deux sorties selon une condition.

**2. Composants mobilisés** — Dispatch, Larger Than, Panel

**3. Zone SUJET — texte du Scribble**

> Sépare la liste de 20 nombres en deux : d'un côté les valeurs supérieures ou égales à 50, de l'autre les valeurs inférieures.

**4. Données de départ fournies** — Une liste de 20 nombres internalisée.

**5. Résultat attendu** — Deux Panels contenant respectivement les valeurs ≥ 50 et < 50.
...
**1. Objectif pédagogique** — Faire tourner l'ordre des éléments d'une liste, opération clé pour relier des points en polygone.

**2. Composants mobilisés** — Shift List, Reverse List, Line

**3. Zone SUJET — texte du Scribble**

> Huit points forment un octogone. Trace les huit segments qui relient chaque point au suivant, le dernier revenant au premier, en n'utilisant qu'un seul composant Line.

**4. Données de départ fournies** — Une liste de 8 points internalisée, disposés en cercle.

**5. Résultat attendu** — Huit segments fermant le polygone.
...
**1. Objectif pédagogique** — Assembler plusieurs listes en une seule, bout à bout ou en alternance.

**2. Composants mobilisés** — Merge, Weave, Panel

**3. Zone SUJET — texte du Scribble**

> Deux listes contiennent respectivement A, B, C et 1, 2, 3. Produis la liste A, 1, B, 2, C, 3.

**4. Données de départ fournies** — Deux listes de 3 éléments internalisées.

**5. Résultat attendu** — Un Panel affichant A, 1, B, 2, C, 3.
...
**1. Objectif pédagogique** — Prélever une sous-liste par domaine d'index.

**2. Composants mobilisés** — Sub List, Construct Domain, Split List

**3. Zone SUJET — texte du Scribble**

> La liste contient 20 éléments. Extrais les éléments d'index 5 à 12 inclus.

**4. Données de départ fournies** — Une liste de 20 nombres internalisée.

**5. Résultat attendu** — Une liste de 8 éléments.
...
**1. Objectif pédagogique** — Identifier branches et chemins et savoir les lire dans l'interface.

**2. Composants mobilisés** — Param Viewer, Tree Statistics, Panel

**3. Zone SUJET — texte du Scribble**

> L'arbre fourni contient plusieurs branches. Indique dans un Panel le nombre de branches, puis le chemin exact de la troisième branche.

**4. Données de départ fournies** — Un arbre internalisé de 4 branches contenant chacune 3 éléments.

**5. Résultat attendu** — Un Panel affichant 4 puis le chemin {0;2}.
...
**1. Objectif pédagogique** — Transformer la structure d'un flux et en mesurer l'effet sur le résultat produit.

**2. Composants mobilisés** — Graft, Flatten, Line, Param Viewer

**3. Zone SUJET — texte du Scribble**

> Trois points sont reliés à trois autres points par un composant Line. Sans Graft, on obtient 3 segments. Ajoute un Graft sur l'une des entrées pour obtenir les 9 segments de toutes les combinaisons possibles.
...
**1. Objectif pédagogique** — Supprimer les niveaux de branche inutiles sans écraser la structure utile.

**2. Composants mobilisés** — Simplify Tree, Trim Tree, Param Viewer

**3. Zone SUJET — texte du Scribble**

> L'arbre fourni porte des chemins de la forme {0;0;0;2}. Ramène-le à des chemins à un seul niveau sans perdre le regroupement des éléments.

**4. Données de départ fournies** — Un arbre internalisé de chemins {0;0;0;0} à {0;0;0;3}.

**5. Résultat attendu** — Un arbre de 4 branches aux chemins {0} à {3}.
...
**1. Objectif pédagogique** — Assembler plusieurs listes en un arbre maîtrisé et le redécomposer.

**2. Composants mobilisés** — Entwine, Explode Tree, Merge

**3. Zone SUJET — texte du Scribble**

> Trois listes de longueurs différentes doivent former un arbre de trois branches, puis être réextraites individuellement.

**4. Données de départ fournies** — Trois listes internalisées de 2, 5 et 3 éléments.

**5. Résultat attendu** — Un arbre de 3 branches puis trois sorties séparées identiques aux listes d'origine.
...
**1. Objectif pédagogique** — Réécrire les chemins d'un arbre pour préparer une mise en correspondance.

**2. Composants mobilisés** — Path Mapper, Param Viewer

**3. Zone SUJET — texte du Scribble**

> L'arbre porte les chemins {0;0} à {2;3}. Inverse les deux niveaux pour obtenir {0;0} à {3;2}.

**4. Données de départ fournies** — Un arbre internalisé de 12 branches à deux niveaux.

**5. Résultat attendu** — Un arbre dont les deux niveaux de chemin sont permutés.
...
**1. Objectif pédagogique** — Observer la correspondance appliquée par défaut lorsque deux listes de tailles différentes entrent dans un même composant.

**2. Composants mobilisés** — Addition, Series, List Length, Panel
...
**1. Objectif pédagogique** — Choisir volontairement un mode de correspondance et en mesurer l'effet.

**2. Composants mobilisés** — Longest List, Cross Reference, Addition, List Length

**3. Zone SUJET — texte du Scribble**

> Avec les mêmes listes de 10 et 4 éléments, produis successivement 10 résultats puis 40 résultats, en indiquant à chaque fois le composant employé.

**4. Données de départ fournies** — Deux listes internalisées de 10 et 4 éléments.

**5. Résultat attendu** — Deux Panels affichant 10 puis 40.
...
| **Durée cible** | 6 min |
| **Prérequis** | A-24 |
| **Mode de validation** | Conceptuel (QCM) — tolérance — |
| **Solution de référence** | 0 composants |
| **Gamification associée** | G-17 Quiz éclair |
| **Statut de production** | À produire |

**1. Objectif pédagogique** — Comprendre que Grasshopper recalcule en cascade selon les dépendances, sans ordre imposé par la position sur le canvas.

**2. Composants mobilisés** — Number Slider, Timer, Panel, Profiler (widget)
...
**1. Objectif pédagogique** — Assembler texte et valeurs numériques en un libellé exploitable.

**2. Composants mobilisés** — Concatenate, Text Join, Panel

**3. Zone SUJET — texte du Scribble**

> Pour chacune des 5 pièces, produis le libellé « PIECE-01 : 1250 mm » à partir de la liste des numéros et de la liste des longueurs.

**4. Données de départ fournies** — Deux listes internalisées : 5 numéros et 5 longueurs.

**5. Résultat attendu** — Une liste de 5 libellés au format demandé.
...
**1. Objectif pédagogique** — Extraire une information d'une chaîne structurée.

**2. Composants mobilisés** — Text Split, Replace Text, Text Case, Trim

**3. Zone SUJET — texte du Scribble**

> À partir des références « MEUB-A12-CHENE », extrais uniquement le code central (A12) et convertis-le en minuscules.

**4. Données de départ fournies** — Une liste de 6 références internalisée.

**5. Résultat attendu** — Une liste de 6 codes en minuscules (a12, b07, …).
...
**1. Objectif pédagogique** — Produire un booléen à partir d'une comparaison numérique.

**2. Composants mobilisés** — Equality, Larger Than, Smaller Than, Similarity
...
**1. Objectif pédagogique** — Assembler plusieurs tests en une décision unique.

**2. Composants mobilisés** — Gate And, Gate Or, Gate Not, Larger Than, Smaller Than

**3. Zone SUJET — texte du Scribble**

> Parmi 20 pièces, identifie celles dont la longueur est comprise entre 500 et 1500 mm inclus. Le résultat doit être une liste de booléens.

**4. Données de départ fournies** — Une liste de 20 longueurs internalisée.

**5. Résultat attendu** — Une liste de 20 booléens.
...
**1. Objectif pédagogique** — Utiliser un booléen pour choisir entre deux flux ou filtrer une liste.

**2. Composants mobilisés** — Stream Filter, Stream Gate, Dispatch, Boolean Toggle

**3. Zone SUJET — texte du Scribble**

> Un Boolean Toggle doit basculer l'affichage entre un cercle et un carré, sans supprimer aucun composant.

**4. Données de départ fournies** — Un Circle, un Rectangle et un Boolean Toggle.

**5. Résultat attendu** — Une seule géométrie affichée à la fois, pilotée par le toggle.
...
**1. Objectif pédagogique** — Distinguer direction et longueur d'un vecteur.

**2. Composants mobilisés** — Unit X, Unit Y, Unit Z, Vector 2Pt, Amplitude, Vector Display

**3. Zone SUJET — texte du Scribble**

> Construis le vecteur allant du point (0;0;0) au point (30;40;0), puis produis un vecteur de même direction mais de longueur 100.

**4. Données de départ fournies** — Deux points internalisés.

**5. Résultat attendu** — Un vecteur de longueur 50 et un vecteur de longueur 100, même direction.
...
**1. Objectif pédagogique** — Poser un plan orienté servant de repère à une géométrie.

**2. Composants mobilisés** — XY Plane, Plane Normal, Construct Plane, Deconstruct Plane

**3. Zone SUJET — texte du Scribble**

> Place un cercle de rayon 20 dans un plan passant par le point (0;0;50) et incliné à 30° autour de l'axe X.
...
**1. Objectif pédagogique** — Produire les courbes de base et maîtriser leurs paramètres.

**2. Composants mobilisés** — Line, Circle, Rectangle, Polygon, Arc, Ellipse

**3. Zone SUJET — texte du Scribble**

> Dans le plan XY, construis un hexagone régulier inscrit dans un cercle de rayon 40, et le rectangle circonscrit à ce même cercle.

**4. Données de départ fournies** — Canvas vide.

**5. Résultat attendu** — Un hexagone de rayon 40 et un rectangle de 80 × 80.
...
**1. Objectif pédagogique** — Répartir des points le long d'une courbe et récupérer les repères locaux.

**2. Composants mobilisés** — Divide Curve, Divide Length, Evaluate Curve, Curve Frames

**3. Zone SUJET — texte du Scribble**

> Répartis 12 points équidistants le long de la courbe fournie, puis place un cercle de rayon 5 perpendiculaire à la courbe à chacun de ces points.

**4. Données de départ fournies** — Une courbe libre internalisée.

**5. Résultat attendu** — 12 cercles de rayon 5 perpendiculaires à la courbe.
...
**1. Objectif pédagogique** — Distinguer courbe interpolée et courbe de contrôle.

**2. Composants mobilisés** — Interpolate, Nurbs Curve, PolyLine, Kink Fillet

**3. Zone SUJET — texte du Scribble**

> À partir des 6 points fournis, trace la courbe qui passe exactement par tous les points, puis celle qui les utilise comme points de contrôle. Superpose les deux.

**4. Données de départ fournies** — Une liste de 6 points internalisée.

**5. Résultat attendu** — Deux courbes distinctes sur les mêmes points.
...
**1. Objectif pédagogique** — Appliquer une translation et comprendre que la transformation conserve l'original.

**2. Composants mobilisés** — Move, Unit Z, Multiplication, Vector 2Pt

**3. Zone SUJET — texte du Scribble**

> Déplace le cercle fourni de 120 mm vers le haut, puis produis 5 copies échelonnées tous les 24 mm sans utiliser de composant de réseau.

**4. Données de départ fournies** — Un cercle internalisé dans le plan XY.

**5. Résultat attendu** — 6 cercles superposés espacés de 24 mm.
...
**1. Objectif pédagogique** — Tourner et refléter une géométrie autour d'un repère choisi.

**2. Composants mobilisés** — Rotate, Mirror, Radians, XZ Plane

**3. Zone SUJET — texte du Scribble**

> Fais tourner le profil fourni de 45° autour de l'axe Z passant par l'origine, puis produis son symétrique par rapport au plan XZ.
...
**1. Objectif pédagogique** — Produire une matrice régulière d'objets et lire la structure de données obtenue.

**2. Composants mobilisés** — Rectangular Array, Polar Array, Param Viewer

**3. Zone SUJET — texte du Scribble**

> Produis une trame de 5 × 4 cellules espacées de 600 mm en X et 400 mm en Y, puis une couronne de 12 copies réparties sur 360°.
...
**1. Objectif pédagogique** — Distinguer l'échelle uniforme et l'échelle non uniforme et maîtriser le centre.

**2. Composants mobilisés** — Scale, Scale NU, Area, Bounding Box

**3. Zone SUJET — texte du Scribble**

> Réduis le profil à 60 % de sa taille en conservant son centre de gravité, puis produis une version étirée deux fois plus haute sans modifier sa largeur.
...
**1. Objectif pédagogique** — Passer d'une courbe à une surface par les deux voies les plus courantes.

**2. Composants mobilisés** — Extrude, Loft, Unit Z, Ruled Surface

**3. Zone SUJET — texte du Scribble**

> Le fichier contient deux profils fermés superposés. Produis la surface qui les relie, puis extrude le profil du bas de 200 mm vers le haut. Compare les deux résultats.

**4. Données de départ fournies** — Deux profils fermés internalisés à 0 et 300 mm.

**5. Résultat attendu** — Une surface loftée et une surface extrudée.
...
**1. Objectif pédagogique** — Générer une surface par déplacement d'un profil le long d'un rail ou autour d'un axe.

**2. Composants mobilisés** — Sweep 1, Sweep 2, Revolution, Rail

**3. Zone SUJET — texte du Scribble**

> Balaie le profil circulaire fourni le long de la courbe guide pour obtenir un tube, puis produis un vase par révolution du profil plan autour de l'axe Z.
...
**1. Objectif pédagogique** — Obtenir un solide fermé et savoir le vérifier.

**2. Composants mobilisés** — Cap Holes, Brep Join, Is Solid (Brep Wireframe / Volume)

**3. Zone SUJET — texte du Scribble**

> La polysurface fournie comporte deux ouvertures. Ferme-la et prouve dans un Panel qu'elle est bien un solide.

**4. Données de départ fournies** — Une polysurface ouverte internalisée.

**5. Résultat attendu** — Un Panel affichant True pour le caractère solide, et un volume non nul.
...
**1. Objectif pédagogique** — Combiner des solides et contrôler l'ordre des opérandes.

**2. Composants mobilisés** — Solid Union, Solid Difference, Solid Intersection

**3. Zone SUJET — texte du Scribble**

> Perce le bloc fourni de quatre trous cylindriques de 20 mm de diamètre traversants, puis calcule le volume de matière retirée.

**4. Données de départ fournies** — Un bloc et quatre cylindres internalisés.

**5. Résultat attendu** — Le bloc percé et un Panel affichant le volume retiré.
...
**1. Objectif pédagogique** — Extraire les points, courbes ou surfaces d'intersection entre objets.

**2. Composants mobilisés** — Curve | Curve, Brep | Plane, Brep | Brep, Curve | Brep

**3. Zone SUJET — texte du Scribble**

> Coupe le solide fourni par un plan horizontal à mi-hauteur et récupère le contour de coupe. Indique sa longueur totale.

**4. Données de départ fournies** — Un solide internalisé.

**5. Résultat attendu** — Le contour de coupe et un Panel affichant sa longueur développée.
...
**1. Objectif pédagogique** — Identifier les objets en interférence dans un ensemble.

**2. Composants mobilisés** — Collision One|Many, Graft, Flatten Tree, Dispatch, Custom Preview, Colour Swatch

**3. Zone SUJET — texte du Scribble**

> Parmi les 15 blocs disposés, identifie ceux qui entrent en collision avec le volume de gabarit fourni et affiche-les en rouge.

**4. Données de départ fournies** — 15 blocs et un volume de gabarit internalisés.

**5. Résultat attendu** — Les 9 blocs en collision, isolés par Dispatch et affichés en rouge.
...
**1. Objectif pédagogique** — Mesurer les trois grandeurs de base et repérer le composant adapté à chaque type.

**2. Composants mobilisés** — Length, Area, Volume, Mass Addition

**3. Zone SUJET — texte du Scribble**

> Pour l'assemblage fourni, affiche dans un même Panel le développé total des arêtes, la surface développée et le volume, dans cet ordre.

**4. Données de départ fournies** — Un solide internalisé.

**5. Résultat attendu** — Un Panel de trois valeurs.
...
**1. Objectif pédagogique** — Analyser localement une courbe et localiser un point de référence.

**2. Composants mobilisés** — Curvature, Curve Closest Point, Evaluate Curve, Graph Mapper

**3. Zone SUJET — texte du Scribble**

> Sur la courbe fournie, identifie le point de courbure maximale et indique son rayon de courbure.

**4. Données de départ fournies** — Une courbe libre internalisée.

**5. Résultat attendu** — Un point marqué sur la courbe et un Panel affichant le rayon de courbure.
...
**1. Objectif pédagogique** — Obtenir le centroïde d'une surface ou d'un volume et l'utiliser comme repère.

**2. Composants mobilisés** — Area, Volume, Point, Text Tag 3D

**3. Zone SUJET — texte du Scribble**

> Calcule le centre de gravité de chacune des 6 pièces fournies et affiche à cet endroit le numéro de la pièce.

**4. Données de départ fournies** — 6 solides internalisés.

**5. Résultat attendu** — 6 étiquettes numérotées placées aux centroïdes.
...
Un exercice par situation de conception réaliste, résolue en combinant plusieurs composants ou groupes de composants pour aboutir à un algorithme solution. Les plugins d'usage courant sont autorisés lorsqu'ils sont nommés dans l'énoncé.
...
**1. Objectif pédagogique** — Chaîner série, transformation et extrusion pour produire un ouvrage réglementé par un calcul.
...
**1. Objectif pédagogique** — Répartir des éléments à pas maximal imposé, cas classique de calcul d'entraxe.
...
**1. Objectif pédagogique** — Faire varier un paramètre géométrique en fonction d'une distance, méthode fondamentale du paramétrique.
...
**1. Objectif pédagogique** — Projeter une trame plane sur une surface libre en maîtrisant la structure de données.
...
**1. Objectif pédagogique** — Construire une structure par décalage de listes et produire directement son métré.
...
**1. Objectif pédagogique** — Modéliser un assemblage menuisé où toutes les cotes dérivent de trois paramètres.
...
**1. Objectif pédagogique** — Intégrer des jeux de fonctionnement et vérifier l'absence de collision.
...
**1. Objectif pédagogique** — Répartir des tablettes selon une progression non uniforme pilotée par une courbe.
...
**1. Objectif pédagogique** — Construire un détail technique répétitif autour d'un axe, avec contrôle d'inclinaison.
...
**1. Objectif pédagogique** — Concevoir un motif à plat puis l'enrouler sur une surface de révolution.
...
**1. Objectif pédagogique** — Répartir et orienter alternativement des éléments le long d'un parcours.
...
**1. Objectif pédagogique** — Transformer un modèle en tableau de données exploitable.
...
**1. Objectif pédagogique** — Optimiser un débit et quantifier la perte matière.
...
**1. Objectif pédagogique** — Produire des repères lisibles, cohérents et positionnés dans le modèle.
...
**1. Objectif pédagogique** — Mettre en œuvre un algorithme de placement glouton et en mesurer la performance.
...
**1. Objectif pédagogique** — Faire varier une section le long d'un parcours par interpolation contrôlée.
...
**1. Objectif pédagogique** — Extraire des sections structurelles d'une forme libre et préparer leur fabrication.
...
**1. Objectif pédagogique** — Construire une hélice et balayer un profil normalisé le long de celle-ci.
...
Un projet complet par domaine métier — architecture, mobilier, joaillerie, fabrication. L'apprenant doit choisir sa méthode, structurer sa définition et produire un livrable exploitable, avec vérification d'au moins un indicateur de performance.
...
**1. Objectif pédagogique** — Construire une enveloppe dont chaque élément réagit à une donnée d'analyse, et justifier le résultat par une mesure.
...
**1. Objectif pédagogique** — Générer une structure maillée relaxée et en extraire les données de fabrication.
...
**1. Objectif pédagogique** — Construire une géométrie pilotée par une contrainte de performance vérifiée rang par rang.
...
**1. Objectif pédagogique** — Produire un livrable économique complet à partir d'un modèle, avec traçabilité des hypothèses.
...
**1. Objectif pédagogique** — Aller du modèle paramétrique au fichier de fabrication, en passant par la nomenclature.
...
**1. Objectif pédagogique** — Conjuguer une forme ergonomique libre et une contrainte de fabrication en lamelles droites.
...
**1. Objectif pédagogique** — Produire un configurateur complet, avec variantes discrètes et contrôle de cohérence.
...
**1. Objectif pédagogique** — Assembler plusieurs sous-ensembles techniques en un bijou complet, avec contrôle de poids.
...
**1. Objectif pédagogique** — Répartir des éléments de tailles variées sur une surface courbe en respectant des distances minimales.
...
**1. Objectif pédagogique** — Produire un motif non répétitif contrôlé par des règles, puis le graver physiquement.
...
**1. Objectif pédagogique** — Calculer un développé industriel exact et produire le plan de pliage.
...
**1. Objectif pédagogique** — Boucler la chaîne conception-fabrication avec un livrable machine.
...
Un exercice par technique de gamification. Chaque fiche décrit la technique, sa mise en œuvre dans Magpie et l'exercice qui la porte. Ce lot est transverse : il rejoue des notions déjà traitées dans les lots A, B et C sous une forme ludique.
...
**1. Objectif pédagogique** — Rendre visible la performance immédiate de l'apprenant sur une tâche de tri.
...
**1. Objectif pédagogique** — Découper une tâche en jalons visibles pour soutenir l'effort.
...
**1. Objectif pédagogique** — Travailler la vitesse d'exécution sur des gestes déjà maîtrisés.
...
**1. Objectif pédagogique** — Inciter à réfléchir avant de soumettre, en limitant le nombre de tentatives.
...
**1. Objectif pédagogique** — Valoriser la maîtrise d'une famille complète de composants.
...
**1. Objectif pédagogique** — Enchaîner des difficultés croissantes, chaque niveau ouvrant l'accès au suivant.
...
**1. Objectif pédagogique** — Distinguer la simple réussite de la réussite élégante.
...
**1. Objectif pédagogique** — Récompenser la régularité plutôt que le coup de chance.
...
**1. Objectif pédagogique** — Encourager l'exploration du canvas et des menus contextuels.
...
**1. Objectif pédagogique** — Introduire une part d'aléatoire maîtrisé pour renouveler l'intérêt.
...
**1. Objectif pédagogique** — Consolider le vocabulaire des composants natifs par un jeu de lettres.
...
**1. Objectif pédagogique** — Associer chaque composant à son effet sur les données, par appariement.
...
**1. Objectif pédagogique** — Comprendre la logique des motifs cycliques par une mécanique de rouleaux.
...
**1. Objectif pédagogique** — Travailler la lecture des entrées et sorties d'un composant.
...
**1. Objectif pédagogique** — Reconstituer une figure par déduction géométrique.
...
**1. Objectif pédagogique** — Rechercher une donnée anormale dans un ensemble volumineux.
...
**1. Objectif pédagogique** — Vérifier des connaissances conceptuelles non mesurables par comparaison de géométrie.
...
**1. Objectif pédagogique** — Lever les idées reçues sur les conversions et les comparaisons.
...
**1. Objectif pédagogique** — Identifier un composant par son comportement plutôt que par son nom.
...
**1. Objectif pédagogique** — Développer le réflexe de diagnostic sur une définition qui ne produit pas le résultat attendu.
...
**1. Objectif pédagogique** — Chercher la solution la plus économe, exercice d'élégance algorithmique.
...
**1. Objectif pédagogique** — Éprouver en une seule tâche l'ensemble des notions du chapitre Données et logique.
...
**1. Objectif pédagogique** — Confronter deux approches d'un même problème et en mesurer les écarts.
...
**1. Objectif pédagogique** — Associer un retour immédiat perceptible à chaque action correcte ou fautive.
...
**1. Objectif pédagogique** — Rendre visible le déroulement d'un algorithme plutôt que son seul résultat.
...
**1. Objectif pédagogique** — Colorer le résultat en fonction de sa conformité, pour un diagnostic instantané.
...
**1. Objectif pédagogique** — Inscrire une série d'exercices dans un fil narratif cohérent avec l'identité de la marque.
...
**1. Objectif pédagogique** — Faire construire à l'apprenant un objet personnel qu'il retrouvera tout au long du parcours.
...
**1. Objectif pédagogique** — Installer une habitude de pratique par une tâche courte et renouvelée.
...
**1. Objectif pédagogique** — Travailler la lisibilité et la transmissibilité d'une définition.
...
**1. Objectif pédagogique** — Donner à l'apprenant une vue d'ensemble de son avancement et des chemins possibles.
...
**1. Objectif pédagogique** — Responsabiliser l'apprenant sur le recours à l'aide.
...
| A-15 | Répartir avec Dispatch | A | A3 · Listes | Débutant | 7 min | SetEquality | REF-045, REF-061 |
...
| A-19 | Lire un chemin d'arbre | A | A4 · Arbres de données | Débutant | 7 min | ExactOrderedList | REF-048, REF-051 |
...
| A-27 | Construire une chaîne de caractères | A | A6 · Outils de texte | Débutant | 6 min | ExactOrderedList | REF-057 |
| A-28 | Découper et remplacer du texte | A | A6 · Outils de texte | Débutant | 7 min | ExactOrderedList | REF-058 |
| A-29 | Comparer deux valeurs | A | A7 · Portes logiques | Débutant | 5 min | SingleValue | REF-059 |
| A-30 | Combiner plusieurs conditions | A | A7 · Portes logiques | Débutant | 7 min | SetEquality | REF-060 |
...
| A-43 | Fermer une polysurface en solide | A | A10 · Surfaces et solides | Débutant | 7 min | SingleValue | REF-070 |
...
58 lignes du référentiel sont couvertes par au moins un exercice.
...
| REF-082 | B-12, B-13, B-15, C-04, C-05, C-07, C-11, G-23 |
| REF-083 | B-12, C-04 |
| REF-084 | C-04 |
| REF-085 | B-12 |
| REF-086 | C-04 |
| REF-087 | B-12, C-05, C-12 |
| REF-088 | G-30 |
| REF-090 | A-26, G-25 |
| REF-093 | G-25 |
| REF-094 | C-02 |
| REF-095 | C-01, C-10 |
| REF-098 | G-05 |
| REF-101 | B-17, C-09, G-16 |
| REF-103 | B-18 |
| REF-106 | C-07, G-28 |
| REF-113 | B-13, C-12 |
| REF-114 | C-12 |
| REF-115 | B-10, C-05, C-10, C-11 |
| REF-116 | C-11 |
...
|---|---|---|---|
| Ind. A | Création. Définition de la trame, des conventions de fichier et du catalogue de 111 exercices répartis en 4 lots. | 25/08/2026 | C. THIERRY DE VILLE D'AVRAY |

---

*Fin du document — v0.1-260825 Ind. A — 25/08/2026*
