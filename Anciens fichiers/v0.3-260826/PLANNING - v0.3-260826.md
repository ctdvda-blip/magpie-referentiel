...
Version `v0.3-260826` · Ind. B · mis à jour le 1er septembre 2026
...
|---|---|---|---|---|---|
| A | 49 | 49 | 49 | oui | **terminé** |
| IA | 14 | 14 | 13 | oui | **terminé** — IA-07 livre un plugin, noté sur grille |
| RH | 10 | 10 | 10 | oui | **terminé** |
| GP | 4 | 4 | 4 | oui | **terminé** |
| QT | 3 | 3 | 3 | oui | **terminé** |
| FA | 2 | 2 | 2 | oui | **terminé** |
| PL | 4 | 4 | 3 | oui | **terminé** — PL-03 noté sur grille |
| MP | 3 | 3 | 2 | oui | **terminé** — MP-01 noté sur grille |
| AV | 3 | 3 | 3 | oui | **terminé** |
| DV | 4 | 4 | 3 | oui | **terminé** — DV-04 noté sur grille |
| WB | 3 | 3 | 1 | oui | **terminé** — WB-01 et WB-02 notés sur grille |
| | **99** | **99** | **93** | | |

Les six exercices sans définition sont exactement les six dont le mode de
...
| | |
|---|---|
| Notions au référentiel | 142 |
| Notions couvertes par au moins un exercice | **142 (100 %)** |
...
| DV | 171 min |
| WB | 138 min |
| **Total** | **1 597 min — 26,6 h** |

Répartition par niveau : 66 débutant · 11 intermédiaire · 17 perfectionnement ·
5 expert. Nature : 77 exercices de compétence, 22 questions de connaissance.
...
|---|---|---|---|
| `verifier_fraicheur.py` | tous les livrables | un PDF plus ancien que sa fiche Word, une fiche plus ancienne que sa source | **à jour** |
| `couverture.py` | référentiel | une notion ou une catégorie sans exercice | **142/142** |
...
| **`recette_6_tous_lots.py`** | **les onze lots** | fichiers illisibles, sujets non étanches, corrigés non masqués, `REPONSE_CORRIGE` muette, avertissements inattendus | **93/93 OK** |
| **`recette_7_valeurs.py`** | **les onze lots** | **une valeur de corrigé qui a changé** — le défaut le plus discret, celui de RH-09 | **93/93 conformes** |
| `verifier_liens.py` | site publié | un téléchargement promis mais absent | **576/576** |
...
| Montée de version | La version reste `v0.3-260826`. Une montée en `v0.4-260901` mettrait à jour l'interface, l'en-tête des fiches, le cahier des charges et l'installateur d'un coup. |
...
| Exercices B, C et G | Présents au cahier des charges (18, 12 et 32 items), sans recettes de construction. Hors périmètre des onze lots publiés. |
