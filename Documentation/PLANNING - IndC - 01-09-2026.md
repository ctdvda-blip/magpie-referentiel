...
| 02/09/2026 | Montée en v0.5-260902 | version propagée à toute la chaîne | non mesurée |
...
| Montée de version | **Faite le 02/09/2026** : `v0.4-260901` → `v0.5-260902`, propagée à l'application, aux fiches, au cahier des charges, au guide et à ce planning. Les livrables de la v0.4 sont archivés dans `Anciens fichiers/v0.4-260901/`. |
