...
D_MP02 = [1840, 12, 8, 2260, 15, 9, 1910, 11, 7, 2040,
          14, 6, 1780, 13, 10, 2150, 9, 8, 1990, 12]
...
dict(id=u"MP-02", titre=u"Trouver ce qui coûte le temps de calcul",
     ...
     att=u"La part des trois composants les plus coûteux, en pourcentage "
         u"entier.",
     ...
     donnees_note=u"Le relevé est volontairement très déséquilibré : trois "
                  u"composants au-dessus de 1 800 ms, dix-sept sous 15 ms. "
...
dict(id=u"DV-02", titre=u"Un composant scripté qui parle à RhinoCommon",
     ...
     att=u"La longueur cumulée des portions trop cintrées, à 1 mm près.",
     erreur=u"Échantillonner la courbe trop grossièrement. La courbure varie "
            u"continûment : un échantillon tous les 50 mm peut enjamber "
            u"entièrement une zone trop cintrée et conclure que la pièce est "
            u"fabricable. Le pas d'échantillonnage est un choix, et il doit "
            u"être justifié.",
     donnees_note=u"La courbe présente une zone serrée d'une soixantaine de "
                  u"millimètres : assez large pour être trouvée avec un pas "
                  u"raisonnable, assez étroite pour être manquée avec un pas "
                  u"négligent.",
     mode=u"NumericTolerance", tol=u"1", nb=7,
