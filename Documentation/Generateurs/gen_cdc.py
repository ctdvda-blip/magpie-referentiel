...
A("| 6 | Lot C complet | %d projets | **Fait le 02/09/2026**, sans attendre le moteur de comparaison : l'indicateur numérique le remplace |" % len(LOT_C))
A("")
...
A("| 2 | Le descripteur JSON est présent et cohérent avec la fiche | **Automatisé** — recette 11, comparaison champ à champ avec le registre |")
...
A("| 19 | L'énoncé ne donne pas lui-même la réponse attendue | **Automatisé** — recette 10 ; les exercices de construction et les cibles à atteindre sont exemptés nommément |")
A("| 20 | L'erreur anticipée mène à une valeur DIFFÉRENTE de la bonne | **Automatisé** — recette 9 ; sinon l'apprenant se trompe et l'exercice le valide |")
A("| 21 | Un nom d'objet ne désigne qu'une seule chose dans la recette | **Automatisé** — recette 8 ; un nom réemployé déplace des câbles sans rien signaler |")
A("")
A("---")
A("")
