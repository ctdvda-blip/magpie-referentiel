...
D_FA01_H = [450, 640, 410, 570, 490, 350, 610, 430, 550, 380,
            660, 320, 590, 470, 520, 400, 630, 360, 540, 460]
...
dict(id=u"GP-01", titre=u"Un plan coté qui suit ses paramètres",
     ...
     limite=u"Le périmètre valide le TRACÉ, pas la cotation. Qu'un plan "
            u"porte les bonnes cotes, aux bons endroits et à la bonne "
            u"échelle ne se vérifie pas par un nombre : c'est le formateur "
            u"qui ouvre la mise en page.",
...
dict(id=u"GP-02", titre=u"Un modèle paramétrique de bout en bout",
     ...
     enonce=u"L'escalier est massif, 1 100 mm de large, giron de 280 mm. "
            u"Pour une hauteur d'étage de 2 700 mm et une hauteur de "
            u"marche visée de 175 mm, produisez le volume de béton, en "
            u"mètres cubes.",
     depart=u"Trois valeurs réglables : hauteur d'étage, hauteur de marche "
            u"visée et giron.",
     att=u"6,653 m³ — le volume de béton de l'escalier massif, à 0,001 "
         u"près.",
     erreur=u"Garder 175 mm comme hauteur de marche réelle. 2 700 ÷ 175 "
            u"vaut 15,43 : le nombre de contremarches s'arrondit à 15, et "
            u"c'est alors la HAUTEUR qui se recale, à 180 mm. Conserver "
            u"175 mm donne un escalier de 2 625 mm qui n'atteint pas "
            u"l'étage — de trois quarts de marche.",
     ...
     limite=u"6,653 m³ est le volume GÉOMÉTRIQUE de l'escalier massif. Le "
            u"béton réellement commandé s'y ajoute des pertes de coffrage et "
            u"de reprise — de 3 à 8 % selon l'ouvrage — que ce modèle "
            u"n'anticipe pas.",
     mode=u"NumericTolerance", tol=u"0,001", nb=9,
     comp=u"Round, Division, Series, Multiplication, Mass Addition, Panel",
     etapes=[u"Établir le nombre de contremarches : hauteur d'étage divisée "
             ...
             u"Chaque marche est un bloc de giron × largeur × sa hauteur "
             u"cumulée : la première monte d'une hauteur, la quinzième "
             u"de quinze.",
             u"Mesurer le volume et convertir en mètres cubes."],
     pieges=[u"Prendre la hauteur de marche comme hauteur de chaque bloc : "
             u"on obtient le volume d'une seule assise, pas de l'escalier.",
...
dict(id=u"GP-03", titre=u"Un maillage qu'on peut imprimer",
     ...
     att=u"1 024 faces avec les réglages par défaut du mailleur — la "
         u"correction accepte 5 % autour de cette valeur.",
     ...
     limite=u"Le corrigé maille avec les réglages PAR DÉFAUT, et rend "
            u"1 024 faces. Il ne pilote pas l'écart maximal : ce réglage "
            u"se pose dans la boîte de dialogue de maillage et ne se "
            u"transporte pas dans le fichier. Le corrigé sert donc "
            u"d'ordre de grandeur ; c'est au formateur de vérifier que "
            u"l'apprenant a bien raisonné en écart et non en densité.",
...
dict(id=u"QT-01", titre=u"Le métré d'un plancher bois",
     ...
     limite=u"Le volume est celui du BOIS FINI. Le débit part de sections "
            u"brutes plus grandes — rabotage, tolérance de sciage — et le "
            u"volume commandé au scieur dépasse celui-ci de 8 à 15 % selon "
            u"l'essence et le corroyage.",
...
dict(id=u"QT-02", titre=u"Du métré au prix",
     ...
     limite=u"Le montant est celui de la FOURNITURE. La pose, les "
            u"connecteurs et le levage se chiffrent à part, et représentent "
            u"couramment autant que le bois lui-même sur un plancher.",
...
dict(id=u"FA-01", titre=u"Combien de panneaux pour ce débit",
     ...
     att=u"4 — le nombre minimal théorique de panneaux. La surface "
         u"exige 3,10 panneaux, et l'on n'en commande pas un dixième.",
     ...
     donnees_note=u"Vingt pièces de dimensions réalistes pour du mobilier, "
                  u"dont la surface totale vaut 3,10 panneaux : arrondir au plus "
                  u"proche donnerait 3, et il manquerait de quoi débiter "
                  u"un dixième du lot. Arrondir au supérieur donne 4.",
...
dict(id=u"FA-02", titre=u"Le développé d'une virole",
     ...
     limite=u"La surface développée est celle de la TÔLE NUE. Un flan de "
            u"découpe y ajoute les recouvrements de soudure et les pertes "
            u"d'imbrication : la commande matière se fait sur le flan, pas "
            u"sur le développé.",
