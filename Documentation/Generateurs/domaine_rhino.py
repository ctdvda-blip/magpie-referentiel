...
dict(id=u"RH-08", titre=u"Un caisson vraiment fermé",
     ...
     depart=u"Un fichier Rhino contenant le caisson, extérieur 420 × 260 × "
            u"180 mm, parois de 12 mm, présentant des défauts de jonction.",
     att=u"Le volume du caisson étanche, à 1 mm³ près.",
     ...
     donnees_note=u"Les défauts sont des arêtes nues de faible longueur, "
                  u"invisibles au rendu : c'est le cas réel, et c'est ce qui "
                  u"rend le contrôle numérique indispensable.",
...
dict(id=u"RH-09", titre=u"Une pièce imprimable",
     ...
     depart=u"Un fichier Rhino contenant la pièce, et les cotes du volume "
            u"d'impression.",
     att=u"Le facteur d'échelle maximal, à 0,01 près, arrondi vers le bas.",
     ...
     donnees_note=u"Les trois dimensions de la pièce ne sont pas "
                  u"proportionnelles à celles du plateau : le facteur "
                  u"limitant n'est pas le même selon l'axe, et il faut "
                  u"retenir le plus petit des trois.",
