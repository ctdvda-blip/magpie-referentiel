...
def sujet(e, seul):
    ...
    L.append(u"")
    # La fiche apprenant annonce la NATURE du résultat, pas sa valeur : la
    # donner reviendrait à écrire la réponse sur l'énoncé.
    # Le sujet est le meme sur les deux fiches : il annonce la NATURE du
    # resultat. La valeur n'appartient qu'au corrige.
    L.append(pour_apprenant(e))
    L.append(u"")
...
def corrige(e, ressource=None):
    ...
    L.append(u"")
    if fuite(e):
        L.append(u"### La valeur attendue")
        L.append(u"")
        L.append(u"> %s" % e["att"])
        L.append(u"")
        L.append(u"*Cette valeur ne figure pas sur la fiche remise à "
