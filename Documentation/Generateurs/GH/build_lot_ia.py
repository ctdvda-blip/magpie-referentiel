# -*- coding: utf-8 -*-
"""
MAGPIE - Production du LOT IA (domaine 11).
=============================================================
...
SORTIE = os.path.join(PROJET, "EXERCICES", "LOT IA - IA et assistance generative")
...
from domaine_ia import LOT_IA as LOT_A      # meme nom interne, autre contenu
import recipes_ia

RECETTES = dict(recipes_ia.R)
...
def main(dry=False):
    ...
    print("=" * 74)
    print("MAGPIE - production du LOT IA")
    print("=" * 74)
