...
> À ne consulter qu'après avoir cherché. Dans le fichier `DV-04_complet.gh`, le corrigé occupe la zone basse du canvas, chaque étape formant un groupe distinct. Il est **autonome** : les données fournies y sont recopiées, aucun câble ne le relie à la zone sujet. Il ne produit rien tant que l'interrupteur **AFFICHER LE CORRIGÉ** n'est pas basculé sur vrai — remettez-le sur faux pour faire disparaître le résultat.
...
**Étape 3.** Figer le GUID du composant dès la première version.
...
| `DV-04_complet.gh` | Énoncé **et** corrigé commenté étape par étape |
| `DV-04.json` | Descripteur pour le plugin Magpie |
| `DV-04_fiche.md` | La présente fiche |
| `DV-04_fiche_sujet.md` | La fiche sans le corrigé, pour l'apprenant |
| `DV-04_fiche.docx` | La fiche Word illustrée, sujet et corrigé |
| `DV-04_fiche_sujet.docx` | La fiche Word illustrée, sujet seul |
