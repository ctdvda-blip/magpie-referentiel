...
| **Référence au référentiel** | REF-040, REF-053, REF-056 |
...
Ce qui coûte le plus cher n'est pas ce qu'on ignore, c'est ce qu'on croit savoir. Le quiz éclair vise exactement ces comportements que l'on subit sans les avoir jamais formulés.
...
Le fichier `G-17_complet.gh` reste disponible comme support de démonstration au vidéoprojecteur. Il n'est pas à faire construire.
