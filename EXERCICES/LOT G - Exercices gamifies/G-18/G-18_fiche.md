...
| **Référence au référentiel** | REF-040, REF-041, REF-059 |
...
Les conversions implicites sont commodes tant qu'on sait lesquelles existent. Le vrai/faux à élimination décourage le pile ou face, qui donnerait sept bonnes réponses sur quinze sans rien savoir.
...
Le fichier `G-18_complet.gh` reste disponible comme support de démonstration au vidéoprojecteur. Il n'est pas à faire construire.
